...
class ChatOpenAI:
    def __init__(self, api_key: str = None, provider: str = "openai", base_url: str = None):
        """
        ...
        Args:
            ...
            base_url: Base URL for the provider (required for Ollama)
        """
        ...
        if self.provider == "together":
            ...
            # base_url is already set from parameter
            pass
        else:
    ...
    def run(self, messages, model_name: str = "gpt-4.1-mini", text_only: bool = True, **kwargs):
        ...
        if self.provider == "ollama":
            ...
            # Use OpenAI-compatible client for OpenAI and Together.ai
