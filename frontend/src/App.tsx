...
function App() {
  ...
  const modelDescriptions = {
    ...
    // Anthropic models (Claude 4 and 4.5 families)
    'claude-sonnet-4-5': 'Claude Sonnet 4.5 - Best for agents and coding',
    ...
    'claude-opus-4': 'Claude Opus 4 - Previous generation Opus',
    'claude-haiku-3-5': 'Claude Haiku 3.5 - Previous generation Haiku'
  }
  ...
  return (
    <div className="app">
      ...
      <main className="main-content">
        <ChatInterface
          apiKey={
            selectedProvider === 'together' ? togetherApiKey :
